...
| `mtc` | Material Test Certificate | **AuthorizedOnly** |  | eli/reg/2024/1781 | The EN 10204 certificate is a B2B inspection document issued to the purchaser, professional detail rather than consumer information. |
...
| `technologyRoute` | Technology Route | **Public** |  | eli/reg/2024/1781 | The steelmaking route (e.g. BF-BOF vs EAF) is the headline green-steel differentiator buyers and consumers rely on, without exposing installation-level emissions data. |
