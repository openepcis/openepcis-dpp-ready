...
| **GS1 Rail Vocabulary** (GS1 AISBL / GS1 Switzerland) | Sectoral Layer 2 upstream profile — railway-specific sensor metadata, wheel diagnostics, EPCIS Registry shapes | Mirror under `extensions/upstream/gs1-rail/`, additive bridge context (`rail-bridge-context.jsonld`) |
