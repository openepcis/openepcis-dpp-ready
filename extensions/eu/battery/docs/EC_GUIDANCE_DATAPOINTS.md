...
| 67 | Information on the status of the battery, defined as 'original', 'repurposed', 're-used… | BR Annex XIII 4 (c) | M | M | M | dynamic | `eubat:BatteryStatus` → [`epcis/commissioning.jsonld`](../epcis/commissioning.jsonld) |
